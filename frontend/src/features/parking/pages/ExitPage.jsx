...
function ExitPage() {
  ...
  const searchVehicle = async () => {
    ...
    try {
      const res = await fetch(`/api/staff/exit/search?keyword=${keyword}`)
  ...
  const processExit = async (parkingId) => {
    ...
    try {
      const res = await fetch('/api/staff/exit/process', {
        method: 'POST',
  ...
  const forceExit = async (parkingId) => {
    ...
    try {
      const res = await fetch('/api/staff/exit/force', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ parkingId })
      })
  ...
  const sendNotification = async (parkingId) => {
    ...
    try {
      const res = await fetch('/api/staff/exit/notify', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ parkingId })
      })
  ...
  const cancelExit = async (parkingId) => {
    ...
    try {
      const res = await fetch('/api/staff/exit/cancel', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ parkingId })
      })
  ...
  const loadParkingList = async () => {
    try {
      const visitRes = await fetch('/api/staff/exit/list/visit')
      setVisitList(await visitRes.json())

      const residentRes = await fetch('/api/staff/exit/list/resident')
  ...
  const loadRecentExitList = async () => {
    try {
      const res = await fetch('/api/staff/exit/list/recent')
